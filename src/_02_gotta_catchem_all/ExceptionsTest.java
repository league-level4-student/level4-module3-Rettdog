...
class ExceptionsTest {
	...
	public void testDivideByZeroException() {
		...
		try {
			assertEquals(ExceptionMethods.divide(5,5),1);
			ExceptionMethods.divide(10,0);
			fail("dsfas");
			
		}catch(IllegalArgumentException e) {
			e.printStackTrace();
			assertEquals(ExceptionMethods.divide(10,2),5);
	...
	public void testReverseString() {
		...
		try {
			assertEquals(ExceptionMethods.reverseString(test),"dlroW olleH");
